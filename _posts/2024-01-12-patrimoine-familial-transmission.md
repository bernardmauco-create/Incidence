...
Le tri se fait par nature de support (verre, film, papier, diapositives), puis par format. Cette étape évite les mélanges et facilite ensuite une reproduction fidèle, image par image.

## 2) Adapter la reproduction au support

Les plaques de verre cassées ou altérées demandent souvent une reproduction dédiée sur banc macro, plus fiable qu’un simple passage scanner quand il faut reconstruire finement certaines zones.

## 3) Nettoyer avec prudence, sans agressivité

Les surfaces sont sensibles : poussières, traces de doigts, rayures et parfois moisissures sur diapositives. Le nettoyage reste mesuré pour protéger l’émulsion et limiter les interventions lourdes en post-production.

## 4) Restaurer sans dénaturer l’intention du photographe

L’objectif n’est pas de produire une image “moderne”, mais de retrouver lisibilité, contraste et justesse colorimétrique, tout en respectant le contexte historique de la prise de vue.
