...
Les défauts (rayures, micro-fissures) demandent un fichier riche en détails. Plus la capture est précise, plus la restauration peut rester naturelle.
...
Si l’envoi est nécessaire, privilégiez un emballage rigide, un calage soigné, et un suivi. Nous vous indiquons la marche à suivre selon votre lot.

{: .muted }
Voir aussi : [prestations](../prestations.html) • [avant/après](../avant-apres.html) • [guide restauration photo ancienne](restauration-photo-ancienne-guide.html).
